    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Have a question or need help? We typically respond within a few hours.
        </p>
      </section>
          ...
          {[
            {
              ...
              action: 'support@checkapi.io',
              href: 'mailto:support@checkapi.io',
            },
            {
              icon: <MessageCircle className="h-8 w-8 text-green-600" />,
              title: 'Live Chat',
              description: 'Chat with us directly from the dashboard.',
            ...
            <div key={i} className="bg-white p-6 rounded-xl border border-gray-200 hover:border-green-300 hover:shadow-lg transition text-center">
              ...
              <a href={item.href} className="text-green-600 font-medium hover:text-green-700 transition">
                {item.action}
              </a>
            </div>
          ))}
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-10 shadow-sm">
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              <textarea
                rows={5}
                className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition resize-none"
