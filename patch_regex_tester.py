...
# ── 1. RegexTestPanel 컴포넌트 생성 ──────────────────────────────────────────
COMP_FILE = r"C:\home\jeon\api-health-monitor\frontend\components\RegexTestPanel.tsx"
...
with open(COMP_FILE, 'w', encoding='utf-8') as f:
    f.write(component)
print("RegexTestPanel created!")


# ── 2. 모니터 디테일 page.tsx에 RegexTestPanel 추가 ──────────────────────────
...
# import 추가
old_import = "import AssertionsPanel from '@/components/AssertionsPanel';"
new_import = "import AssertionsPanel from '@/components/AssertionsPanel';\nimport RegexTestPanel from '@/components/RegexTestPanel';"
c = c.replace(old_import, new_import)

# AssertionsPanel 뒤에 RegexTestPanel 추가
old_assertions = "        {/* Assertions */}\n        <AssertionsPanel monitorId={monitorId} />"
...
with open(FILE_DETAIL, 'w', encoding='utf-8') as f:
    f.write(c)
print("Monitor detail updated!", "RegexTestPanel" in c)
