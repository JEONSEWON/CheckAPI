    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950">
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 pb-24">
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-10 shadow-sm space-y-10 text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">3. Alert Channels</h2>
          ...
          <div>
            ...
            <p>Monitor check history is retained for 30 days on the Free plan, 30 days on Starter, 90 days on Pro, and 1 year on Business. You may delete your account and all associated data at any time from your account settings.</p>
          </div>
