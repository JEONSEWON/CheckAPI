FILE = r"C:\home\jeon\api-health-monitor\frontend\app\blog\page.tsx"

content = """import PublicAuthButtons from '@/components/PublicAuthButtons';
...
print("Done!")
print("posts count:", content.count("slug:"))
