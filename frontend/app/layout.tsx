...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://www.checkapi.io"),
  alternates: { canonical: "/" },
  verification: { google: "aPu3HfP0HcYJs4r-_azPdbeT1x8q_bLvWzHqoe_xay4" },
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://www.checkapi.io",
    title: "checkapi.io | Simple API Monitoring by Axiom Technologies",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className={`${inter.className} ${dmSans.variable} ${dmMono.variable}`} suppressHydrationWarning>
        <Providers>
          {children}
