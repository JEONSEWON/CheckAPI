...
# 현재 구조 확인
print("monitors.length === 0 위치:", content.find("monitors.length === 0"))
print("divide-y divide-gray-200 위치:", content.find("divide-y divide-gray-200"))

# monitors가 있을 때 리스트 앞에 온보딩 배너 삽입
old = """          ) : (
