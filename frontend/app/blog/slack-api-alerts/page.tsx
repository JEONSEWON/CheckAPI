    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24">
        ...
        <div className="prose prose-lg max-w-none space-y-8 text-gray-700 dark:text-gray-200 leading-relaxed">
          ...
          <div className="bg-green-50 dark:bg-green-950 border border-green-200 rounded-xl p-6">
          ...
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mt-12">Step 1: Create a Slack Webhook</h2>
          <p>First, you need an Incoming Webhook URL from Slack. This is the URL CheckAPI will send alerts to.</p>

          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 shadow-sm space-y-4">
            {[
          ...
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mt-12">Step 2: Add the Webhook to CheckAPI</h2>
          ...
          <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl p-8 text-center mt-12">
            ...
            <Link href="/register" className="inline-flex items-center bg-white text-green-600 px-8 py-3 rounded-lg hover:bg-gray-50 dark:bg-gray-900 transition font-medium">
