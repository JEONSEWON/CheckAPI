...
c = c.replace(old_export, assertions_api + "\n" + old_export)

with open(FILE_API, 'w', encoding='utf-8') as f:
    f.write(c)
print("api.ts done!", "assertionsAPI" in c)


# ── 2. AssertionsPanel 컴포넌트 생성 ─────────────────────────────────────────
COMP_FILE = r"C:\home\jeon\api-health-monitor\frontend\components\AssertionsPanel.tsx"
...
with open(COMP_FILE, 'w', encoding='utf-8') as f:
    f.write(component)
print("AssertionsPanel component created!")


# ── 3. 모니터 디테일 page.tsx에 AssertionsPanel 추가 ─────────────────────────
FILE_DETAIL = r"C:\home\jeon\api-health-monitor\frontend\app\dashboard\monitors\[id]\page.tsx"

with open(FILE_DETAIL, 'r', encoding='utf-8', errors='ignore') as f:
    c = f.read()

# import 추가
old_import = "import { monitorsAPI, analyticsAPI, alertChannelsAPI } from '@/lib/api';"
...
# Recent Checks 섹션 앞에 AssertionsPanel 삽입
old_checks = "        {/* Recent Checks */}"
new_checks = """        {/* Assertions */}
        <AssertionsPanel monitorId={monitorId} />

        {/* Recent Checks */}"""
c = c.replace(old_checks, new_checks)

with open(FILE_DETAIL, 'w', encoding='utf-8') as f:
    f.write(c)
print("Monitor detail page updated!", "AssertionsPanel" in c)
